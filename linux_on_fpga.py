...
from linux_on_litex_vexriscv.soc_linux import SoCLinux
...
class Board:
    soc_kwargs = {"integrated_rom_size": 0x9000, "l2_size": 0}
...
# Qmtech_xc7a35t_256 support -----------------------------------------------------------------------------------

class Qmtech_xc7a35t_256(Board):
    soc_kwargs = {
        "uart_baudrate" : 115200,
        "sys_clk_freq"   : int(50e6), 
    } 
    def __init__(self):
        import qmtech_xc7a35t_256
        Board.__init__(self, qmtech_xc7a35t_256.BaseSoC, soc_capabilities={
            # Communication
            "serial",
            # Storage
            "spisdcard",
...
supported_boards = {
    ...
    "qmtech_xc7a35t_256":   Qmtech_xc7a35t_256,
    "arty":             Arty,
    "arty_a7":          ArtyA7,
    "arty_s7":          ArtyS7,
    "netv2":            NeTV2,
